    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-6 space-y-6">
        <div className="text-center">
          ...
          <h1 className="mt-3 text-xl font-bold text-gray-900">Sign in to ProCalender</h1>
          <p className="mt-1 text-sm text-gray-500">Schedule and manage meetings with ease</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <button
            ...
            disabled={loading}
            className="flex justify-center items-center py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
          >
